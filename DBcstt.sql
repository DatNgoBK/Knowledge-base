...
--
-- Host: 127.0.0.1
-- Generation Time: May 09, 2018 at 04:23 AM
...
`id` int(11) NOT NULL,
  ...
  `comment` text CHARACTER SET utf16 COLLATE utf16_vietnamese_ci
...
INSERT INTO `comment` (`id`, `student_id`, `reason`, `comment`) VALUES
(1, '20150569', '1:', 'hay'),
(2, '20150569', '1:3:6:', 'không đúng lắm');
...
(13, 'SSH1130 228', 'Đường lối CM của Đảng CSVN', 3, 'CORE', '01:02:03', '', 'SSH1110 228:SSH1120 228'),
...
(47, 'IT4079 228', 'Ngôn ngữ và phương pháp dịch', 2, 'CS', '01:02:03', 'abc', ''),
...
INSERT INTO `credit` (`id`, `cpa`, `credit`) VALUES
('CR001', 3.2, 21),
('CR002', 2.5, 18),
('CR003', 0, 15);
...
(2, '20150569', 'MI1120 228', 'A'),
(3, '20150569', 'MI1130 228', 'A'),
(4, '20150569', 'MI1140 228', 'A'),
(5, '20150569', 'PH1110 228', 'A'),
(6, '20150569', 'PH1120 228', 'A'),
(7, '20150569', 'EM1010 228', 'A'),
(8, '20150569', 'IT1110 228', 'A'),
(9, '20150569', 'SSH1110 228', 'B'),
(10, '20150569', 'SSH1120 228', 'A'),
(11, '20150569', 'SSH1050 228', 'C'),
(12, '20150569', 'SSH1130 228', 'B'),
(13, '20150569', 'SSH1170 228', 'A'),
(14, '20150569', 'PE1010 228', 'C'),
(15, '20150569', 'PE1020 228', 'C'),
(16, '20150569', 'PE1030 228', 'C'),
(17, '20150569', 'PE201x 228', 'B'),
(18, '20150569', 'MIL1110 228', 'B'),
(19, '20150569', 'MIL1120 228', 'B'),
(20, '20150569', 'MIL1130 228', 'B'),
(21, '20150569', 'MI2020 228', 'B'),
(22, '20150569', 'PH1130 228', 'A'),
(23, '20150569', 'IT2000 228', 'A'),
(24, '20150569', 'IT3010 228', 'A'),
(25, '20150569', 'IT3020 228', 'B'),
(26, '20150569', 'IT3030 228', 'A'),
(27, '20150569', 'IT3040 228', 'A'),
(28, '20150569', 'IT3070 228', 'A'),
(29, '20150569', 'IT3080 228', 'B'),
(30, '20150569', 'IT3090 228', 'B'),
(31, '20150569', 'IT3100 228', 'A'),
(32, '20150569', 'IT3110 228', 'A'),
(33, '20150569', 'IT3120 228', 'B'),
(34, '20150569', 'IT3910 228', 'A'),
(35, '20150569', 'IT4010 228', 'B'),
(36, '20150569', 'IT4040 228', 'A'),
(37, '20150569', 'IT4080 228', 'A');
...
INSERT INTO `reason` (`id`, `reason`, `number`) VALUES
(1, 'Quá nhiều môn học', 2),
(2, 'Quá ít môn học', 0),
(3, 'Chưa gợi ý đúng các môn yêu thích', 1),
(4, 'Các môn học quá khó', 0),
(5, 'Các môn gợi ý không đúng trong chương trình đào tạo', 0),
(6, 'Chưa đủ các keyword', 1);
...
INSERT INTO `statistical` (`status`, `number`) VALUES
('Thích', 1),
('Không thích', 1);
