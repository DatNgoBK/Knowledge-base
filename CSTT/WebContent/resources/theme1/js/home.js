...
//    				$(".cart-quantity").html(parseInt($(".cart-quantity").html()) + $('.quantity-single').val());
//    			},
					...
					'<div class="product-block">' + 
						...
						'<div class="product-content">' + 
							...
							'<div class="shopping-btn">' + 
								'<a href="#" class="product-btn btn-like add-to-cart">' + 
...
//	alert("page" + page);
//	alert('{' + typeSort + ','+page+','+ brandID + ',' + price + ',' + ram + ',' + memory +'}');
//	if ( (brandID + ',' + price + ',' + ram + ',' + memory ) 
//			== ('"brandID": "","price": "","ram": "","memory": ""') && currentPage == 1) {
//		currentPage++;
//	}
		...
		success: function (listProduct) {
    		...
    		$.ajax({
    			...
    			success: function (count) {
    				$("#load-more").html("Xem them (con " + count + " san pham)");
    				if (count == 0) {
...
//				var price = parseFloat($(this).text()).toLocaleString("slv");
//				$(this).html(price);
//			});
...
//	$('#add-to-cart').click(function() {
//		alert("hihi");
//		alert("cart.htm?phoneID=" + $('#quantity-single').attr('id') +"&command=plus&quantity=" + $('#quantity-single').val());
//		$.ajax({
//    			type: "GET",
//    			encoding:"UTF-8",
//    			contentType: "text/plain; charset=UTF-8",
//    			url: "cart.htm?phoneID=" + $('#quantity-single').attr('id') +"&command=plus&quantity=" + $('#quantity-single').val(),
//    			success: function (result) {
//    				$("html, body").animate({ scrollTop: 0 }, "slow");
//    			},
//    			failure: function (response) {
